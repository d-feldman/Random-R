...
###fix datacoding for question 32
D2 <- D2 %>% mutate(fhs32_mo_v2 = case_when(fhs32_mo_v2 == 2 ~ 1, fhs32_mo_v2 == 1 ~ 0)) %>% 
  mutate(fhs32_fa_v2 = case_when(fhs32_fa_v2 == 2 ~ 1, fhs32_fa_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib1_v2 = case_when(fhs32_sib1_v2 == 2 ~ 1, fhs32_sib1_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib2_v2 = case_when(fhs32_sib2_v2 == 2 ~ 1, fhs32_sib2_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib3_v2 = case_when(fhs32_sib3_v2 == 2 ~ 1, fhs32_sib3_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib4_v2 = case_when(fhs32_sib4_v2 == 2 ~ 1, fhs32_sib4_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib5_v2 = case_when(fhs32_sib5_v2 == 2 ~ 1, fhs32_sib5_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib6_v2 = case_when(fhs32_sib6_v2 == 2 ~ 1, fhs32_sib6_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib7_v2 = case_when(fhs32_sib7_v2 == 2 ~ 1, fhs32_sib7_v2 == 1 ~ 0)) %>%
  mutate(fhs32_sib8_v2 = case_when(fhs32_sib8_v2 == 2 ~ 1, fhs32_sib8_v2 == 1 ~ 0))
